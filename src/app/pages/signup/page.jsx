...
import signup_bg_img from '../../../../public/images/signup_bg_img.png';
...
const formSchema = z.object({
    ...
    return data.password === data.passwordConform
}, {
...
const SignUp = () => {
    ...
    return (
        <motion.div 
            ...
            className="signup w-full h-screen relative overflow-hidden flex justify-center items-center"
            >

            <Image src={signup_bg_img} alt="signup_bg_img.png" className='w-full object-cover absolute top-0 left-0 max-[1550px]:h-full' />
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
            ...
            <motion.div 
                ...
                >
                    Let's Sign Up To <span className='text-yellow-400'> I Love My Six </span> Account
                </h1>
                <Form {...form}>
                    <form action="" onSubmit={form.handleSubmit(handleSubmit)} className='w-full flex flex-col gap-4 max-[640px]:px-5 max-[640px]:pt-0'>
                        ...
                        <div className='w-full flex flex-col justify-center items-center max-[320px]:mb-3'>
                            <ButtonSecondary name="Sign up" type="submit" class="input_bg w-52 text-xl text-gray-400 mt-3 font-bold hover:text-gray-100" />
                            <h3 className='text-gray-400 mt-10 text-center'> Already have an account? <Link href='/pages/signin' className='text-yellow-500 hover:underline'> let's Sign in </Link> </h3>
                        </div>
